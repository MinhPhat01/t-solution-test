...
const OurNews = () => {
  ...
  return (
    <div className="px-[160px]">
      <h2 className="mt-[69px] mb-[31px] w-[118px] h-[36px] text-[24px] leading-[35.5px] text-[#000000] font-bold mx-auto">
        Our News
      </h2>
      <div className="grid grid-cols-3 gap-x-[32px] gap-y-[24px]">
        {data.length > 0 &&
          data.map((item) => {
            return (
              <Post
